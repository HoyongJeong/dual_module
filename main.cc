...
void PrintHelp()
{
	std::cout << "usage: dual_module [-b] [-g] [-m macrofile]" << std::endl;
	std::cout << std::endl;
	std::cout << "Examples:" << std::endl;
	std::cout << "  dual_module -b -m myRun.mac  # Run in batch mode with macro and config." << std::endl;
	std::cout << "  dual_module -g               # Run in graphical mode."                   << std::endl;
	std::cout << std::endl;
